...
public class SimpleProgressTarget<Z> extends ProgressTarget<String, Z> {
    private static final String TAG = "LOG_PROGRESS_TAR";
    private final TextView text;
    private final ProgressBar progress;
    private final ImageView image;

    public SimpleProgressTarget(Target<Z> target, ProgressBar progress, ImageView image, TextView text) {
        super(target);
    ...
    protected void onDownloading(long bytesRead, long expectedLength) {
        ...
        Log.d(TAG, "Downloading : " + bytesRead);
        ...
        String progressData = String.format("%.1f%%",100f * bytesRead / expectedLength);
